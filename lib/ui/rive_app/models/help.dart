...
class HelpCenterPage extends StatelessWidget {
  ...
  void _goToHome(BuildContext context) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => HelpCenterPage()), // Navigate to home
    );
  }
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => RiveAppHome()), // Redirect to the HomePage (or HelpCenterPage)
            );
          },
...
class HelpDetailPage extends StatelessWidget {
  ...
  const HelpDetailPage({required this.title, required this.questions, super.key});
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => HelpCenterPage()), // Go back to the home page
            );
          },
        ),
      ),
